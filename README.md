The custom RMD script, along with executable batch script, CSS for styling the HTML page and R-script to load packages and locate RStudio on Windows. This project generates an integrated HTML report aggregating all clinically relevant genomic variant types, detected using in-house build RNA-seq pipeline.
